...
class HashTable:
    ...
    def unique(
        self, values: np.ndarray, return_inverse: bool = ..., mask=...
    ) -> (
        tuple[
            np.ndarray,
            npt.NDArray[np.intp],
    ...
    def factorize(
        self, values: np.ndarray, na_sentinel: int = ..., na_value: object = ..., mask=..., ignore_na: bool = ...
...
def duplicated(
    values: np.ndarray, keep: Literal["last", "first", False] = ..., mask: npt.NDArray[np.bool_] | None = ...
