...
def astype_overflowsafe(
    values: np.ndarray, dtype: np.dtype, copy: bool = ..., round_ok: bool = ..., is_coerce: bool = ...
) -> np.ndarray: ...
...
def add_overflowsafe(left: npt.NDArray[np.int64], right: npt.NDArray[np.int64]) -> npt.NDArray[np.int64]: ...
