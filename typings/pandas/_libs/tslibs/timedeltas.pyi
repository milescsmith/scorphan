...
def ints_to_pytimedelta(m8values: npt.NDArray[np.timedelta64], box: bool = ...) -> npt.NDArray[np.object_]: ...
...
class Timedelta(timedelta):
    ...
    _value: int
    def __new__(
        cls: type[_S], value=..., unit: str | None = ..., **kwargs: float | np.integer | np.floating
    ) -> _S | NaTType: ...
    @property
    def days(self) -> int: ...
    @property
    ...
    def to_numpy(self, dtype: npt.DTypeLike = ..., copy: bool = ...) -> np.timedelta64: ...
