...
def ensure_string_array(
    arr, na_value: object = ..., convert_na_value: bool = ..., copy: bool = ..., skipna: bool = ...
...
def indices_fast(
    index: npt.NDArray[np.intp], labels: np.ndarray, keys: list, sorted_labels: list[npt.NDArray[np.int64]]
...
def generate_bins_dt64(
    values: npt.NDArray[np.int64], binner: np.ndarray, closed: object = ..., hasnans: bool = ...
) -> np.ndarray: ...
