...
def get_fill_indexer(mask: npt.NDArray[np.bool_], limit: int | None = ...) -> npt.NDArray[np.intp]: ...
...
def take_2d_multi_int8_int8(
    values: np.ndarray, indexer: tuple[npt.NDArray[np.intp], npt.NDArray[np.intp]], out: np.ndarray, fill_value=...
) -> None: ...
