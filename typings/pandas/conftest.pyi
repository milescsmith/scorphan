...
@pytest.fixture(
    params=[None, "gzip", "bz2", "zip", "xz", "tar", pytest.param("zstd", marks=td.skip_if_no("zstandard"))]
)
...
@pytest.fixture(params=["gzip", "bz2", "zip", "xz", "tar", pytest.param("zstd", marks=td.skip_if_no("zstandard"))])
...
@pytest.fixture(
    params=[
        ...
        if not (key.startswith(("int", "uint", "float")) or key in ["range", "empty", "repeats", "bool-dtype"])
...
@pytest.fixture(params=[operator.eq, operator.ne, operator.gt, operator.ge, operator.lt, operator.le])
...
@pytest.fixture(
    ...
    ids=["string=string[python]", "string=string[pyarrow]", "string=str[pyarrow]", "string=str[python]"],
)
...
@pytest.fixture(params=["string[python]", pytest.param("string[pyarrow]", marks=td.skip_if_no("pyarrow"))])
