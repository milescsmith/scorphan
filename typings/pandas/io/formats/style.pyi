...
class Styler(StylerRenderer):
    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    def apply_index(
        self, func: Callable, axis: AxisInt | str = ..., level: Level | list[Level] | None = ..., **kwargs
    ) -> Styler:
        """
    ...
    def set_sticky(
        self, axis: Axis = ..., pixel_size: int | None = ..., levels: Level | list[Level] | None = ...
    ) -> Styler:
        """
    ...
    def hide(
        self, subset: Subset | None = ..., axis: Axis = ..., level: Level | list[Level] | None = ..., names: bool = ...
    ) -> Styler:
        """
    ...
    def highlight_null(self, color: str = ..., subset: Subset | None = ..., props: str | None = ...) -> Styler:
        """
    ...
    def highlight_max(
        self, subset: Subset | None = ..., color: str = ..., axis: Axis | None = ..., props: str | None = ...
    ) -> Styler:
        """
    ...
    def from_custom_template(
        cls, searchpath: Sequence[str], html_table: str | None = ..., html_style: str | None = ...
    ) -> type[Styler]:
        """
