...
class HDFStore:
    ...
    **kwargs, the HDF5 file is loaded or created in-memory and will only be
    ...
    _mode: str
    def __init__(
        self, path, mode: str = ..., complevel: int | None = ..., complib=..., fletcher32: bool = ..., **kwargs
    ) -> None: ...
    ...
    def append_to_multiple(
        self, d: dict, value, selector, data_columns=..., axes=..., dropna: bool = ..., **kwargs
    ) -> None:
        """
...
class AppendableTable(Table):
    ...
    def write_data_chunk(
        self, rows: np.ndarray, indexes: list[np.ndarray], mask: npt.NDArray[np.bool_] | None, values: list[np.ndarray]
    ) -> None:
        """
        Parameters
        ----------
