...
from pandas._typing import DtypeBackend, FilePath, HTMLFlavors, ReadBuffer, StorageOptions
...
class _HtmlFrameParser:
    ...
    def parse_tables(self):  # -> Generator[tuple[list[Any], list[Any], list[Any]], None, None]:
        """
