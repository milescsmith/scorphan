...
from typing import Any, Callable, Literal, NamedTuple, TYPE_CHECKING, TypedDict, overload
...
def validate_integer(name: str, val: int | float | None, min_val: int = ...) -> int | None:
    """
...
class TextFileReader(abc.Iterator):
    ...
    """
    def __init__(
        self, f: FilePath | ReadCsvBuffer[bytes] | ReadCsvBuffer[str] | list, engine: CSVEngine | None = ..., **kwds
    ) -> None: ...
    def close(self) -> None: ...
