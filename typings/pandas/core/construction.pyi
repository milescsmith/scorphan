...
def ensure_wrapped_if_datetimelike(arr):  # -> DatetimeArray | TimedeltaArray | ndarray[_Shape, dtype[Any]]:
    """
...
def sanitize_array(
    data, index: Index | None, dtype: DtypeObj | None = ..., copy: bool = ..., *, allow_2d: bool = ...
) -> ArrayLike:
    """
