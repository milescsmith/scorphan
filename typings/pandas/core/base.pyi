...
class IndexOpsMixin(OpsMixin):
    ...
    @final
    def to_numpy(
        self, dtype: npt.DTypeLike | None = ..., copy: bool = ..., na_value: object = ..., **kwargs
    ) -> np.ndarray:
        """
    ...
    @overload
    def searchsorted(
        self, value: ScalarLike_co, side: Literal["left", "right"] = ..., sorter: NumpySorter = ...
    ) -> np.intp: ...
    @overload
    def searchsorted(
        self, value: npt.ArrayLike | ExtensionArray, side: Literal["left", "right"] = ..., sorter: NumpySorter = ...
    ) -> npt.NDArray[np.intp]: ...
