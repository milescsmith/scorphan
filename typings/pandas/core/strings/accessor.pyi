...
def forbid_nonstring_types(forbidden: list[str] | None, name: str | None = ...) -> Callable[[F], F]:
    """
...
class StringMethods(NoNewAttributesMixin):
    ...
    def cat(self, others=..., sep: str | None = ..., na_rep=..., join: AlignJoin = ...) -> str | Series | Index:
        """
    ...
    def split(
        self, pat: str | re.Pattern | None = ..., *, n=..., expand: bool = ..., regex: bool | None = ...
    ):  # -> DataFrame | dict[int, ArrowExtensionArray] | list[Any | list[Any]] | Index | MultiIndex | Series:
        ...
    @Appender(
        _shared_docs["str_split"]
    ...
    @forbid_nonstring_types(["bytes"])
    def startswith(self, pat: str | tuple[str, ...], na: Scalar | lib.NoDefault = ...) -> Series | Index:
        """
    ...
    @forbid_nonstring_types(["bytes"])
    def endswith(self, pat: str | tuple[str, ...], na: Scalar | lib.NoDefault = ...) -> Series | Index:
        """
    ...
    @forbid_nonstring_types(["bytes"])
    def extract(self, pat: str, flags: int = ..., expand: bool = ...) -> DataFrame | Series | Index:
        r"""
    ...
    @Appender(
        _shared_docs["find"]
        % {"side": "lowest", "method": "find", "also": "rfind : Return highest indexes in each strings."}
    )
    @forbid_nonstring_types(["bytes"])
    def find(
    ...
    @Appender(
        _shared_docs["find"]
        % {"side": "highest", "method": "rfind", "also": "find : Return lowest indexes in each strings."}
    )
    @forbid_nonstring_types(["bytes"])
    def rfind(
        self, sub, start: int = ..., end=...
