...
class BlockManager(libinternals.BlockManager, BaseBlockManager):
    ...
    def iset(
        self, loc: int | slice | np.ndarray, value: ArrayLike, inplace: bool = ..., refs: BlockValuesRefs | None = ...
    ) -> None:
        """
...
def create_block_manager_from_blocks(
    blocks: list[Block], axes: list[Index], consolidate: bool = ..., verify_integrity: bool = ...
) -> BlockManager: ...
