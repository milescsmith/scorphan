...
class Block(PandasObject, libinternals.Block):
    ...
    def make_block_same_class(
        self, values, placement: BlockPlacement | None = ..., refs: BlockValuesRefs | None = ...
    ) -> Self:
    ...
    @final
    def astype(
        self, dtype: DtypeObj, copy: bool = ..., errors: IgnoreRaise = ..., using_cow: bool = ..., squeeze: bool = ...
    ) -> Block:
        """
    ...
    @final
    def take_nd(
        self, indexer: npt.NDArray[np.intp], axis: AxisInt, new_mgr_locs: BlockPlacement | None = ..., fill_value=...
    ) -> Block:
        """
