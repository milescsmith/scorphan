...
def rec_array_to_mgr(
    data: np.rec.recarray | np.ndarray, index, columns, dtype: DtypeObj | None, copy: bool, typ: str
) -> Manager:
    """
...
def dict_to_mgr(
    data: dict, index, columns, *, dtype: DtypeObj | None = ..., typ: str = ..., copy: bool = ...
) -> Manager:
    """
    Segregate Series based on type and coerce into matrices.
    Needs to handle a lot of exceptional cases.
...
def convert_object_array(
    content: list[npt.NDArray[np.object_]], dtype: DtypeObj | None, dtype_backend: str = ..., coerce_float: bool = ...
) -> list[ArrayLike]:
    """
