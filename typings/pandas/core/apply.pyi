...
class Apply(metaclass=abc.ABCMeta):
    ...
    def compute_list_like(
        self, op_name: Literal["agg", "apply"], selected_obj: Series | DataFrame, kwargs: dict[str, Any]
    ...
    def wrap_results_dict_like(
        self, selected_obj: Series | DataFrame, result_index: list[Hashable], result_data: list
    ):  # -> DataFrame | Series:
        ...
...
def relabel_result(
    result: DataFrame | Series, func: dict[str, list[Callable | str]], columns: Iterable[Hashable], order: Iterable[int]
