...
from pandas._typing import AnyArrayLike, ArrayLike, IndexLabel, JoinHow, MergeHow, Suffixes, npt
...
def get_join_indexers(
    left_keys: list[ArrayLike], right_keys: list[ArrayLike], sort: bool = ..., how: JoinHow = ...
