...
class BaseWindowGroupby(BaseWindow):
    ...
    _attributes: list[str] = ...
    def __init__(
        self, obj: DataFrame | Series, *args, _grouper: BaseGrouper, _as_index: bool = ..., **kwargs
    ) -> None: ...
...
class RollingAndExpandingMixin(BaseWindow):
    ...
    def kurt(self, numeric_only: bool = ...):  # -> DataFrame | Series:
        ...
    def quantile(
        self, q: float, interpolation: QuantileInterpolation = ..., numeric_only: bool = ...
    ):  # -> DataFrame | Series:
        ...
    def rank(
        self, method: WindowingRankType = ..., ascending: bool = ..., pct: bool = ..., numeric_only: bool = ...
    ):  # -> DataFrame | Series:
        ...
    def cov(
        self,
