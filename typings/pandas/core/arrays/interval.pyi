...
class IntervalArray(IntervalMixin, ExtensionArray):
    ...
    def from_breaks(
        cls, breaks, closed: IntervalClosedType | None = ..., copy: bool = ..., dtype: Dtype | None = ...
    ) -> Self: ...
    @classmethod
    @Appender(
    ...
    def from_arrays(
        cls, left, right, closed: IntervalClosedType | None = ..., copy: bool = ..., dtype: Dtype | None = ...
    ) -> Self: ...
    @classmethod
    @Appender(
    ...
    def from_tuples(
        cls, data, closed: IntervalClosedType | None = ..., copy: bool = ..., dtype: Dtype | None = ...
    ) -> Self: ...
    @property
    ...
    def argsort(
        self, *, ascending: bool = ..., kind: SortKind = ..., na_position: str = ..., **kwargs
    ) -> np.ndarray: ...
