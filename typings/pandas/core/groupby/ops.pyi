...
class WrappedCythonOp:
    ...
    def cython_operation(
        self, *, values: ArrayLike, axis: AxisInt, min_count: int = ..., comp_ids: np.ndarray, ngroups: int, **kwargs
    ) -> ArrayLike:
        """
...
class BaseGrouper:
    ...
    axis: Index
    def __init__(
        self, axis: Index, groupings: Sequence[grouper.Grouping], sort: bool = ..., dropna: bool = ...
    ) -> None: ...
    @property
