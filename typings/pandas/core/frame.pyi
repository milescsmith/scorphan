...
class DataFrame(NDFrame, OpsMixin):
    ...
    @classmethod
    def from_dict(
        cls, data: dict, orient: FromDictOrient = ..., dtype: Dtype | None = ..., columns: Axes | None = ...
    ) -> DataFrame:
        """
    ...
    @overload
    def to_dict(
        self, orient: Literal["records"], *, into: type[MutableMappingT] | MutableMappingT, index: bool = ...
    ...
    @classmethod
    def from_records(
        cls, data, index=..., exclude=..., columns=..., coerce_float: bool = ..., nrows: int | None = ...
    ) -> DataFrame:
        """
    ...
    def insert(
        self, loc: int, column: Hashable, value: Scalar | AnyArrayLike, allow_duplicates: bool | lib.NoDefault = ...
    ) -> None:
        """
    ...
    @overload
    def set_index(
        self, keys, *, drop: bool = ..., append: bool = ..., inplace: Literal[False] = ..., verify_integrity: bool = ...
    ) -> DataFrame: ...
    @overload
    def set_index(
        self, keys, *, drop: bool = ..., append: bool = ..., inplace: Literal[True], verify_integrity: bool = ...
    ) -> None: ...
    def set_index(
        self, keys, *, drop: bool = ..., append: bool = ..., inplace: bool = ..., verify_integrity: bool = ...
    ) -> DataFrame | None:
        """
    ...
    def update(
        self, other, join: UpdateJoin = ..., overwrite: bool = ..., filter_func=..., errors: IgnoreRaise = ...
    ) -> None:
        """
    ...
    def unstack(self, level: IndexLabel = ..., fill_value=..., sort: bool = ...):  # -> DataFrame | Series:
        """
    ...
    def sum(
        self, axis: Axis | None = ..., skipna: bool = ..., numeric_only: bool = ..., min_count: int = ..., **kwargs
    ):  # -> Any:
        ...
    ...
    def mean(
        self, axis: Axis | None = ..., skipna: bool = ..., numeric_only: bool = ..., **kwargs
    ):  # -> Series | float | int:
        ...
    ...
    def sem(
        self, axis: Axis | None = ..., skipna: bool = ..., ddof: int = ..., numeric_only: bool = ..., **kwargs
    ):  # -> Series | float | int:
        ...
    ...
    def to_timestamp(
        self, freq: Frequency | None = ..., how: ToTimestampHow = ..., axis: Axis = ..., copy: bool | None = ...
    ) -> DataFrame:
        """
