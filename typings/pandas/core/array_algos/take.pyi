...
def take_nd(arr: ArrayLike, indexer, axis: AxisInt = ..., fill_value=..., allow_fill: bool = ...) -> ArrayLike:
    """
...
def take_2d_multi(
    arr: np.ndarray, indexer: tuple[npt.NDArray[np.intp], npt.NDArray[np.intp]], fill_value=...
) -> np.ndarray:
    """
    Specialized Cython take which sets NaN values in one pass.
    """
