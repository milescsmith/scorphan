...
class MultiIndex(Index):
    ...
    @classmethod
    def from_arrays(
        cls, arrays, sortorder: int | None = ..., names: Sequence[Hashable] | Hashable | lib.NoDefault = ...
    ) -> MultiIndex:
        """
    ...
    @classmethod
    def from_frame(
        cls, df: DataFrame, sortorder: int | None = ..., names: Sequence[Hashable] | Hashable | None = ...
    ) -> MultiIndex:
        """
    ...
    def take(
        self: MultiIndex, indices, axis: Axis = ..., allow_fill: bool = ..., fill_value=..., **kwargs
    ) -> MultiIndex: ...
    ...
    def drop(
        self, codes, level: Index | np.ndarray | Iterable[Hashable] | None = ..., errors: IgnoreRaise = ...
    ) -> MultiIndex:
        """
