...
class Index(IndexOpsMixin, PandasObject):
    ...
    def sortlevel(
        self, level=..., ascending: bool | list[bool] = ..., sort_remaining=..., na_position: NaPosition = ...
    ...
    @final
    def get_indexer(
        self, target, method: ReindexMethod | None = ..., limit: int | None = ..., tolerance=...
    ) -> npt.NDArray[np.intp]:
        """
    ...
    @overload
    def join(
        self, other: Index, *, how: JoinHow = ..., level: Level = ..., return_indexers: Literal[True], sort: bool = ...
    ...
    @overload
    def join(
        self, other: Index, *, how: JoinHow = ..., level: Level = ..., return_indexers: bool = ..., sort: bool = ...
...
def get_values_for_csv(
    values: ArrayLike, *, date_format, na_rep: str = ..., quoting=..., float_format=..., decimal: str = ...
