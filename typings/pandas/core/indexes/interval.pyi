...
@inherit_names(
    ["__array__", "overlaps", "contains", "closed_left", "closed_right", "open_left", "open_right", "is_empty"],
    IntervalArray,
)
...
class IntervalIndex(ExtensionIndex):
    ...
    def __reduce__(self):  # -> tuple[Callable[..., Any], tuple[type[Self], dict[str, Index | str | Hashable]], None]:
        ...
    @property
...
def interval_range(
    start=..., end=..., periods=..., freq=..., name: Hashable | None = ..., closed: IntervalClosedType = ...
) -> IntervalIndex:
    """
