...
@inherit_names(
    ["tz", "tzinfo", "dtype", "to_pydatetime", "date", "time", "timetz", "std"] + DatetimeArray._bool_ops, DatetimeArray
)
class DatetimeIndex(DatetimeTimedeltaMixin):
    ...
    def __reduce__(self):  # -> tuple[Callable[..., Any], tuple[type[Self], dict[str, DatetimeArray | Hashable]], None]:
        ...
